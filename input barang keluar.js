...
if ($_GET['form']=='add') {
 ...
 $query = mysqli_query($mysqli, "SELECT id_barang,nama_barang,stok
 FROM is_barang
...
<!-- Content Header (Page header) -->
 ...
 <!-- form start -->
 <form id="form-barang-keluar" role="form" class="form-horizontal"
action="modules/barang-keluar/proses.php?act=insert" method="POST"
name="formBarangKeluar">
 <div class="box-body">
 <?php
 // fungsi untuk membuat id transaksi
 $query_id = mysqli_query($mysqli, "SELECT
RIGHT(id_barang_keluar,7) as kode FROM is_barang_keluar
 ORDER BY id_barang_keluar DESC LIMIT 1")
 or die('Ada kesalahan pada query tampil
id_barang_keluar : '.mysqli_error($mysqli));
...
87
 ...
 <div class="col-sm-5">
 <input type="text" class="form-control" name="id_barang_keluar"
value="<?php echo $id_barang_keluar; ?>" readonly required>
 </div>
 </div>
 <div class="form-group">
 <label class="col-sm-2 control-label">Tanggal</label>
 <div class="col-sm-5">
 <input type="text" class="form-control date-picker" data-dateformat="dd-mm-yyyy" name="tanggal_keluar" autocomplete="off" value="<?php
echo date("d-m-Y"); ?>" required readonly style="background-color: #ffffff">
 </div>
 </div>
 <hr>
 <div class="form-group">
...
$data_barang[id_barang] | $data_barang[nama_barang] </option>";
 ...
 <div class="col-sm-5">
 <input style="width: 40px" type="text" class="form-control" id="stok"
name="stok" value="<?php echo $stok; ?>" readonly>
 </div>
 </div>
88
 </span>
...
name="jumlah_keluar" autocomplete="off" onKeyPress="return
goodchars(event,'0123456789',this)"
onkeyup="cek_jumlah_keluar(this)&cek_stok(this)&hitung_sisa_stok(this)"
required>
 </div>
 </div>
 <div class="form-group">
...
name="simpan" value="Simpan">
 <a href="?module=barang_keluar" class="btn btn-default btnreset">Batal</a>
 </div>
 </div>
 </div><!-- /.box footer -->
 </form>
...
$(document).ready (function() {
 $('#form-barang-keluar').formValidation({
 framework: 'bootstrap',
 excluded: 'disabled',
 icon: {
89
 ...
 validators: {
 notEmpty: {
 message: 'Jumlah keluar belum diisi'
 }
 }
 }
 }
